...
Dieser Draht verursacht eine Störung der Moden und unterdrückt diese somit. Befindet sich der Draht genau an der Stelle eines \text{imu}ms der Grundmode TEM$_{00}$, so wird diese \text{ima}l gestört.
...
Dazu werden die Abstände $d_n$ der Beugungs\text{ima} zur optischen Achse gemessen.
